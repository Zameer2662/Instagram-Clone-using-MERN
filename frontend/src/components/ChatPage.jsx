                ...
                <div className='overflow-y-auto h-[80vh]'>

                    {
                        suggestedUsers.map((suggestedUser) => {
                            ...
                            return (
                                <div onClick={() => dispatch(setSelectedUser(suggestedUser))} className='flex gp-3 items-center p-3 hover:bg-gray-50 cursor-pointer'>
                                    ...
                                    <div className='flex flex-col '>
                                        ...
                                        <span className={`text-xs ${isOnline ? 'text-green-600' : 'text-red-600'}`}>{isOnline ? 'onilne' : 'Offline'}</span>
                                    </div>
                                </div>
                            )
                        })
